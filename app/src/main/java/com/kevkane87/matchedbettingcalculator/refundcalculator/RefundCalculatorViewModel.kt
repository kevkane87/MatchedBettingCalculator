package com.kevkane87.matchedbettingcalculator.refundcalculator
...
class RefundCalculatorViewModel(application: Application) : ViewModel() {
    ...
    fun calculate() {
        ...
        if (canCalculate()) {
            ...
            _layStake.value = layStakeQualNorRef(
                _backBetStake.value!!,
                _backBetOdds.value!!,
                backCommDecimal,
                layOdds,
            ...
            //_layStake.value = _layLiability.value!! / _layBetOdds.value!!
            ...
            _profitLayWins.value =
                profitLayWinsQual(_layStake.value!!, _backBetStake.value!!, layCommDecimal)  + refundAmount
           ...
           /* _layStakeRefund.value = refundAmount  / (_layOddsRefund.value!! * (1-layCommRefundDecimal))
            ...
            _profitBackWins.value = _profitBackWins.value!!
            _profitLayWins.value = _profitLayWins.value!! */
