...
class RefundIfCalculatorViewModel(application: Application) : ViewModel() {
    ...
    fun canCalculate(): Boolean {
        ...
        return _backBetOdds.value != null && _backBetStake.value != null && _layBetOdds.value != null && _layOddsRefund.value != null && _refund.value != null && _refundRetention.value != null && _backBetOdds.value != 0.0 && _backBetStake.value != 0.0 && _layBetOdds.value != 0.0 && _layOddsRefund.value != 0.0 && _layOddsRefund.value != 0.0 && _refund.value != 0.0 && _refundRetention.value != 0.0
    }
